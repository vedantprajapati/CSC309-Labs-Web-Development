...
class Class(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if is_creating:
            ...
            #cancel all sessions if end date is changed
            for session in self.class_sessions.filter(time__gte=self.end_date):
                session.delete()

            #if class is cancelled, cancel all future sessions
